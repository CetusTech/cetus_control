...
@ManagedBean
@RequestScoped
public class TaskTypeMBean extends GeneralManagedBean{
  ...
  /** The list register. */
  private List< TaskTypeDTO > listRegister            = null;
  
  /** The add object. */
  private TaskTypeDTO         addObject               = null;
  
  /** The selected object. */
  private TaskTypeDTO         selectedObject          = null;
  ...
  public TaskTypeMBean () {
    addObject = new TaskTypeDTO();
    selectedObject = new TaskTypeDTO();
  }
  ...
  private void listRegister () {
    ...
    try {
      ...
      response = generalDelegate.findTaskType( getUserDTO().getPerson().getClient().getClientCetus().getId() );
      if ( UtilCommon.validateResponseSuccess( response ) ) {
        //Respuesta del servicio 
        this.listRegister = ( List< TaskTypeDTO > ) response.getObjectResponse();
      } else {
        //si no encontro registro para listar 
        if ( UtilCommon.validateResponseNoResult( response ) ) {
          this.listRegister = new ArrayList< TaskTypeDTO >();
        }
      }
    } catch ( Exception e ) {
  ...
  public String remove () {
    ...
    try {
      ...
      selectedObject = ( TaskTypeDTO ) getObjectSession( "selectedObject" );
  ...
  public void loadUpdate ( ActionEvent event ) {
    TaskTypeDTO statusDTO = null;
    try {
      if ( selectedObject != null ) {
        statusDTO = ( TaskTypeDTO ) getObjectSession( "selectedObject" );
        if ( statusDTO != null ) {
  ...
  public String add () {
    ...
    try {
      ...
      addObject = ( TaskTypeDTO ) getObjectSession( "addObject" );
      if ( addObject != null ) {
        if ( getUserDTO() != null ) {
  ...
  public List< TaskTypeDTO > getListRegister () {
    return listRegister;
  }

  public void setListRegister ( List< TaskTypeDTO > listRegister ) {
    this.listRegister = listRegister;
  }

  public TaskTypeDTO getAddObject () {
    return addObject;
  }

  public void setAddObject ( TaskTypeDTO addObject ) {
    this.addObject = addObject;
  }

  public TaskTypeDTO getSelectedObject () {
    return selectedObject;
  }

  public void setSelectedObject ( TaskTypeDTO selectedObject ) {
