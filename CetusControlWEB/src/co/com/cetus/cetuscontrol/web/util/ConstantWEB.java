...
public class ConstantWEB {
  ...
  public final static int        STATUS_INPROGRESS                   = Integer.parseInt( UtilWEB.getProperty( NAME_BUNDLE_WEB,
                                                                                                              "STATUS_INPROGRESS" ) );
  ...
  public final static String[]   COLUMN_LABEL_TASK_HISTORY           = UtilWEB.getProperty( NAME_BUNDLE_WEB, "COLUMN_LABEL_TASK_HISTORY" )
                                                                              .split( "," );
  public final static String[]   COLUMN_TASK_HISTORY                 = UtilWEB.getProperty( NAME_BUNDLE_WEB, "COLUMN_TASK_HISTORY" ).split( "," );
  public final static String[]   COLUMN_SELECTED_TASK_HISTORY        = UtilWEB.getProperty( NAME_BUNDLE_WEB, "COLUMN_SELECTED_TASK_HISTORY" )
                                                                              .split( "," );
